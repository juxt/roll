...
Roll will preprocess the Roll configuration you give it. The main example is that Roll can derive the most recent application version for you based on the contents of the S3 releases bucket, so you don't have to hardcode the application version manually.
...
TODO Advganes of Aero, munging before and after.

== Usage

To use Roll from the command line, we suggest you use it in conjunction with https://github.com/juxt/mach[Mach] (Mach is your Make). TODO document this.
