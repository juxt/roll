...
Warning: Roll is in active development, everything about it - including this document - is being modified on a regular basis. That said, please read on to get a gist of what Roll is about.

Roll will provision you a Beanstalk like AWS rolling blue/green infrastructure using Terraform, ClojureScript, Aero and Lumo.
